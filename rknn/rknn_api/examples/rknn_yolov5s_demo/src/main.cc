...
void parse_det_arch(float *an, const int an_h, const int an_w, const float an_s, vector<vector<float>> an_wh, PredictBoxes &pred_boxes, PredictScores *pred_scores, int pad_top, int pad_left, int resize_w, int resize_h, int origin_height, int origin_width)
{
...
void parse_det(float *an, const int an_h, const int an_w, const float an_s, vector<vector<float>> an_wh, PredictBoxes &pred_boxes, PredictScores *pred_scores, int pad_top, int pad_left, int resize_w, int resize_h, int origin_height, int origin_width)
{
