...
TEST(NMSTest, IOU05THRES01) {
    ...
    pred_scores_file.open("./pred_scores.dat", ios::in );
    ...
    selected_file.open("./selected.dat", ios::in);
    ...
    pred_boxes_file.open("./pred_boxes.dat", ios::in);
    ...
    ASSERT_EQ(selected, nms_single_class(pred_boxes, pred_scores, 0.1f, 0.5f));
}
